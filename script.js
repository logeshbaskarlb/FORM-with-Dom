// Get the element with the id "survey-form"
let Noo=document.createElement('div')
Noo.id =  'survey-form'

let con=document.createElement('form')
con.setAttribute('id','survey-form')
con.setAttribute('name','myform')
con.classList.add("container-fluid","mx-auto","m-4","p-4","rounded-3")
...
des.innerHTML="Fill the Form with true identity "
...
fname.setAttribute('placeholder','Enter your FirstName')
fname.setAttribute('required','')

document.body.appendChild(con).appendChild(F1).appendChild(ftitle).appendChild(fname)
document.getElementById("first-name").style.width="250px";
...
lname.setAttribute('placeholder','Enter your LastName')
lname.setAttribute("required",'')
lname.setAttribute('id','last-name')
lname.setAttribute('type','text')
lname.classList.add('form-control')

document.body.appendChild(con).appendChild(F1).appendChild(ltitle).appendChild(lname)
document.getElementById("last-name").style.width="250px";
...
E1.classList.add("form-group");
let etitle=document.createElement("label")
etitle.innerText='Email Address'
E1.setAttribute('id', 'email-label')
etitle.classList.add('form-label','my-1')


let ema=document.createElement("input")
ema.setAttribute('type',"email")
ema.setAttribute('placeholder','Enter your email')
ema.setAttribute('id','email')
ema.setAttribute('class','input requied')
ema.classList.add('form-control')
ema.setAttribute('required','')
emai=document.createElement("small")
emai.setAttribute('class','form-text text-muted')
document.body.appendChild(con).appendChild(E1).appendChild(etitle);
document.body.appendChild(con).appendChild(E1).appendChild(ema);
document.body.appendChild(con).appendChild(E1).appendChild(emai)
document.getElementById("email-label").style.width="378px";
document.getElementById("email-label").style.fontWeight="Bold";
...
comments.setAttribute('placeholder','Address')
comments.setAttribute('id',"comments")
comments.setAttribute('required','')
comments.classList.add('form-control')

document.body.appendChild(con).appendChild(F1).appendChild(add_title).appendChild(comments)
document.getElementById("comments").style.height='50px';
document.getElementById("comments").style.width='250px';
document.body.appendChild(con).appendChild(F1).appendChild(add_title)
document.body.appendChild(con).appendChild(F1).appendChild(comments)
...
pin.setAttribute('id','number-label')
...
document.body.appendChild(con).appendChild(F1).appendChild(pin_title).appendChild(pin)
document.getElementById("first-name").style.width="250px";
...
document.getElementById("gen1").style.fontWeight="bold";
...
s2.innerText="Parotta"
flex.appendChild(ch2)
flex.appendChild(s2)
ch2.setAttribute('type','checkbox')
ch2.setAttribute('value','Parotta')
...
s4.innerText="Chicken Noodles"
flex.appendChild(ch4)
flex.appendChild(s4)
ch4.setAttribute('type','checkbox')
ch4.setAttribute('value','Chicken Noodles')
...
r_btn.classList.add("btn","btn-dark","my-4","mx-4")
...
function validate(event){
   ...
   let add_v=document.getElementById("comments").value;  
